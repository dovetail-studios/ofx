...
describe OFX::Transaction do
  ...
  context "debit" do
    ...
    it 'should have user date' do
      @transaction.occurred_at.should == Time.parse("2009-09-09 08:00:00 UTC")
    end
  ...
  context "credit" do
    ...
    it "should have user date" do
      @transaction.occurred_at.should == Time.parse("2009-09-16 08:00:00 UTC")
    end
  ...
  context "with more info" do
    ...
    it "should have user date" do
      @transaction.occurred_at.should == Time.parse("2009-10-17 12:00:00 UTC")
    end
