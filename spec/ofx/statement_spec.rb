...
describe OFX::Statement do
  ...
  context "Bank Account" do
    ...
    it "returns start date" do
      statement.start_date.should == Time.parse("2009-10-09 08:00:00 UTC")
    end

    it "returns end date" do
      statement.end_date.should == Time.parse("2009-11-03 08:00:00 UTC")
    end
  ...
  context "Credit Card" do
    ...
    it "returns start date" do
      statement.start_date.should == Time.parse("2007-05-09 12:00:00 UTC")
    end

    it "returns end date" do
      statement.end_date.should == Time.parse("2007-06-08 12:00:00 UTC")
    end
    ...
    describe "balance" do
      ...
      it "returns balance date" do
        balance.posted_at.should == Time.parse("2007-06-23 19:20:13 UTC")
      end
    end
    ...
    describe "available_balance" do
      ...
      it "returns available balance date" do
        available_balance.posted_at.should == Time.parse("2007-06-23 19:20:13 UTC")
      end
    end
  end
end
